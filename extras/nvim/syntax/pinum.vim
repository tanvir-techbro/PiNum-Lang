...
syntax keyword pinumType int float double char string bool long short signed unsigned vec
highlight link pinumType Type

" 5. Booleans
syntax keyword pinumBool true false
highlight link pinumBool Boolean
